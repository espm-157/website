...
dt = data.frame(c("Instructor", "GSIs", "Location", "Times", "Office Hours"), 
       c('<a href="http://carlboettiger.info">Carl Boettiger</a>  <a href="mailto:cboettig@berkeley.edu" title="email"><i class="fa fa-envelope"></i></a> <a href="https://github.com/cboettig" title="GitHub"><i class="fa fa-github"></i></a>',
       'Ellery Vaughan <a href="mailto:ellery_vaughan@berkeley.edu" title="email"><i class="fa fa-envelope"></i></a>',
       "110 Social Sciences", 
